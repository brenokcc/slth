      ...
      for (
        var c = this,
          d = function (d) {
            ...
            b(d.keyCode) &&
              setTimeout(function () {
                (c.opts.lastOutput = e.lastOutput),
                  (e.value = f[a](e.value, c.opts)),
                  (e.lastOutput = e.value),
                  e.setSelectionRange &&
                    c.opts.suffixUnit &&
                    e.setSelectionRange(
                      e.value.length,
                      e.value.length - c.opts.suffixUnit.length
                    );
              }, 0);
          },
          e = 0,
        ...
        (this.elements[e].lastOutput = ""),
          (this.elements[e].onkeyup = d),
          this.elements[e].value.length &&
            (this.elements[e].value = f[a](this.elements[e].value, this.opts));
    }),
  ...
  return (
    (f.toMoney = function (a, b) {
      if (((b = c(b)), b.zeroCents)) {
        ...
        (a = a.toString().replace(e, "")),
          f < g && (a = a.slice(0, a.length - 1));
      }
      ...
      if (
        (!0 === b.showSignal &&
          (p = a < 0 || (a.startsWith && a.startsWith("-")) ? "-" : ""),
        !b.zeroCents)
      ) {
    ...
    (f.toPattern = function (a, b) {
      ...
      for (c = 0; c < k; c++) {
        ...
        if (
          ("9" === g[c] && h[j].match(/[0-9]/)) ||
          ("A" === g[c] && h[j].match(/[a-zA-Z]/)) ||
          ("S" === g[c] && h[j].match(/[0-9a-zA-Z]/))
        )
          g[c] = h[j++];
        else if ("9" === g[c] || "A" === g[c] || "S" === g[c])
          return void 0 !== l ? d(g, c, l).join("") : g.slice(0, c).join("");
      }
