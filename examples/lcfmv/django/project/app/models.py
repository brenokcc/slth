...
class AcordaoQuerySet(models.QuerySet):
    def all(self):
        ...
        ).search('numero', 'ementa', 'processo').filters('relator', 'data_dou', 'orgao_julgador', 'natureza').rows()
...
class Acordao(models.Model):
    ...
    def formfactory(self):
        return (
            super().formfactory()
            .fieldset('Dados Gerais', (('numero', 'ano'), ('relator:cadastrarrelator', 'data_dou'), ('orgao_julgador', 'natureza')))
    ...
    def serializer(self):
        return (
            super().serializer()
            .fieldset('Dados Gerais', (('numero', 'ano'), ('relator:visualizarrelator', 'data_dou'), ('orgao_julgador', 'natureza')))
...
class LegislacaoQuerySet(models.QuerySet):
    def all(self):
        return self.fields('ementa', ('tipo', 'get_arquivo')).search('numero', 'ementa').filters('tipo', 'data', 'revogada_por')
...
class Legislacao(models.Model):
    ...
    revogada_por = models.ForeignKey('app.legislacao', verbose_name='Revogada Por', null=True, blank=True, on_delete=models.CASCADE)
