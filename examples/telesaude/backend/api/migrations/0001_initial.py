# Generated by Django 4.2.6 on 2024-05-25 21:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assunto', slth.db.models.CharField(max_length=200, verbose_name='Assunto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estados', slth.db.models.ManyToManyField(blank=True, to='api.estado', verbose_name='Estados')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teleconsultor', models.BooleanField(default=True, verbose_name='Teleconsultor')),
                ('teleinterconsultor', models.BooleanField(default=True, verbose_name='Teleinterconsultor')),
                ('pode_atualizar_agenda', models.BooleanField(default=True, help_text='Marque essa opção caso o profissional possa informar os dias e horários de seus atendimentos.', verbose_name='Pode Atualizar Agenda')),
                ('informar_atuacao', models.BooleanField(default=False, help_text='Marque essa opção caso o profissional vá atuar em unidades diferentes daquelas definidas para o núcleo.', verbose_name='Informar atuação')),
                ('especialidade', slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.especialidade')),
                ('estados', slth.db.models.ManyToManyField(blank=True, to='api.estado', verbose_name='Estados')),
                ('municipios', slth.db.models.ManyToManyField(blank=True, to='api.municipio', verbose_name='Municípios')),
                ('nucleo', slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.nucleo', verbose_name='Núcleo')),
                ('pessoa_fisica', slth.db.models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.pessoafisica', verbose_name='Profissional')),
                ('unidades', slth.db.models.ManyToManyField(blank=True, to='api.unidade', verbose_name='Unidades')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='nucleo',
            name='municipios',
            field=slth.db.models.ManyToManyField(blank=True, to='api.municipio', verbose_name='Municípios'),
        ),
        migrations.AddField(
            model_name='nucleo',
            name='operadores',
        ...
        migrations.AddField(
            model_name='nucleo',
            name='unidades',
            field=slth.db.models.ManyToManyField(blank=True, to='api.unidade', verbose_name='Unidades'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='atendimento',
            name='especialista',
            field=slth.db.models.ForeignKey(blank=True, help_text='Profissional de saúde que será consultado pelo profissional responsável pelo atendimento', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='atendimentos_especialista', to='api.profissionalsaude'),
        ),
        migrations.AddField(
            model_name='atendimento',
            name='horario_especialista',
            field=slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='atendimento2', to='api.horarioprofissionalsaude', verbose_name='Horário'),
        ),
        migrations.AddField(
            model_name='atendimento',
            name='horario_profissional_saude',
            field=slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.horarioprofissionalsaude', verbose_name='Horário'),
        ),
        migrations.AddField(
            model_name='atendimento',
            name='paciente',
        ...
        migrations.AddField(
            model_name='atendimento',
            name='profissional',
            field=slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='atendimentos_profissional', to='api.profissionalsaude', verbose_name='Responsável'),
        ),
        migrations.AddField(
            model_name='atendimento',
            name='tipo',
