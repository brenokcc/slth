# Generated by Django 4.2.6 on 2024-05-18 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', slth.db.models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.area', verbose_name='Área Temática')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cns', slth.db.models.CharField(max_length=15, null=True, verbose_name='CNS')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('foto', slth.db.models.ImageField(blank=True, null=True, upload_to='estabelecimentos_saude', verbose_name='Foto')),
                ...
                ('operadores', slth.db.models.ManyToManyField(blank=True, related_name='estabelecimentos_operados', to='app.pessoafisica', verbose_name='Operadores')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estabelecimento', slth.db.models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.unidade', verbose_name='Unidade')),
                ('pessoafisica', slth.db.models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.pessoafisica', verbose_name='Profissional')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='gestores',
            field=slth.db.models.ManyToManyField(blank=True, related_name='municipios_gerenciados', to='app.pessoafisica', verbose_name='Gestores'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='estado',
            name='gestores',
            field=slth.db.models.ManyToManyField(blank=True, to='app.pessoafisica', verbose_name='Gestores'),
        ),
        migrations.CreateModel(
